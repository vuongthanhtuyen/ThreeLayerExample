...
namespace SweetCMS.DataAccess{
    public partial class SPs{
        ...
        /// <summary>
        /// Creates an object wrapper for the AddNewCategoryForPost Procedure
        /// </summary>
        public static StoredProcedure AddNewCategoryForPost(int? PostId, string ListCategoryId)
        {
            SubSonic.StoredProcedure sp = new SubSonic.StoredProcedure("AddNewCategoryForPost", DataService.GetInstance("DataAcessProvider"), "dbo");
        	
            sp.Command.AddParameter("@PostId", PostId, DbType.Int32, 0, 10);
        	
            sp.Command.AddParameter("@ListCategoryId", ListCategoryId, DbType.AnsiString, null, null);
        ...
        /// <summary>
        /// Creates an object wrapper for the SearchPagingCategory Procedure
        /// </summary>
        public static StoredProcedure SearchPagingCategory(int? PageSize, int? PageIndex, string Key, bool? ASC, int? totalrow)
        {
        ...
        /// </summary>
        public static StoredProcedure SearchPagingPost(int? PageSize, int? PageIndex, string Key, bool? ASC, int? totalrow)
        {
